...
const edit_group_dto_1 = require("./dto/edit-group.dto");
const add_group_dto_1 = require("./dto/add-group.dto");
let GroupsController = class GroupsController {
    constructor(groupsService) {
        this.groupsService = groupsService;
    }
    async getOneById(idGroup) {
...
], GroupsController.prototype, "getOneById", null);
__decorate([
    swagger_1.ApiOkResponse({ description: 'Success' }),
    common_1.Get(),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [add_group_dto_1.AddGroupDTO]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [edit_group_dto_1.EditGroupDTO, Number]),
    __metadata("design:returntype", Promise)
